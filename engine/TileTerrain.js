function TileTerrain(primary, secondary, texture, row, column, width, height)
{
    Tile.call(this, primary, texture, row, column, width, height);
    this.secondary = secondary;
}

TileTerrain.prototype.getVariant = function(game, layer, row, column, idPrimary, idSecondary)
{
    var variant = 0;
